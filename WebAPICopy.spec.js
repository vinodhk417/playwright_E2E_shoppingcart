...
test.only ('shopping cart E2E using WebApi ', async ({page})=>
{
    ...
    for (let i=0; i<counts ; ++i)
    {
      ...
      await page.locator("input[placeholder='Select Country']").pressSequentially('ind',{delay:100});
       ...
       // await page.locator(".table-responsive").filter({hasText: '697cfeb2c941646b7ac73839'}).isVisible();
        ...
        await page.locator("tbody tr").filter({hasText: '6a89df4e21054ba465e9fe90'}).locator("td button[class*='btn-primary']").click();

        expect(await page.locator(".col-text")).toHaveText('6a89df4e21054ba465e9fe90');
